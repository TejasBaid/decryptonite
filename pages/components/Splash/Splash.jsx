export default function Splash() {
    return (
        <div className="splash w-screen h-screen flex flex-col items-center justify-center">
            ...
            <h1 className="text-3xl lg:text-5xl text-white font-bold mt-5 lg:mt-8">2022-23</h1>
            <div className="buttons-container flex w-screen justify-center flex-col items-center lg:flex-row mt-6">
